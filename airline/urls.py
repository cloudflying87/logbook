...
from airline.views import DeltaScheduleEntry, Oauth2CallbackView, CalAuthView, workdeltschedulegoogle, setcalid,importingevents,DeletemultipleQuery, simple_upload
urlpatterns = [
